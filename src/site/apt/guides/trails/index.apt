...
* Component-oriented Programming Trail
  ...
  [[1]] {{{../../ref/why-use-components.html} Why Use Components?}}
...
* Component Trail
  ...
  {{{../quick-start/getting-started.html} Five Minute Tutorial}}.

  [[2]] To learn more about writing components, take the {{{./writing-components/index.html} Component Tutorial}}.
...
* Container Trail
  ...
  [[1]] To get started using the Plexus container, try the {{{../quick-start/getting-started.html} Five Minute Tutorial}}.
  
  [[1]] To learn how to use Plexus for web application development, follow the {{{./plexus-web-applications/index.html}Plexus in Web applications}} trail.
