---
title: Using a Plexus Component from a Plexus application.
author: Rahul Thakur
date: 2006-06-08
---
...
The `maven-archetype-mojo` sets up a skeleton Maven plugin project '`plexus-website-monitor-application`' for us with reasonable defaults.
...
1. [Maven Books and Articles](http://maven.apache.org/articles.html).
...
[Next: Plexus Embedder Intro & Site Monitor component integration into the application ](./07_02_plexus_embedder_and_component_integration.html)
