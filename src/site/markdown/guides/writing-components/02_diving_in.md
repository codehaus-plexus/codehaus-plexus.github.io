---
title: Writing your first Plexus Component
author: Rahul Thakur
date: 2006-06-11
---
...
1. a Class "DefaultHelloWorld.java" which implements the interface in (1) above.

1. a Component Descriptor "components.xml" located under _project-root_/src/main/resources/META-INF/
...
Before we implement the the provider, we need to update our project dependencies and include Jakarta Commons HttpClient library. To do this, locate pom.xml under _project-root_ and edit it to reflect the _dependencies_ section of our pom.xml as below:
