...
Introduction
  ...
  declaring a requirement on a list of component instances.
...
~~  {{{./component-requirements.html} Component Requirements Tutorial}}.
  ...
  Component lifecycles in Plexus are discussed in the {{{./components.html} Components Tutorial}}.
~~ as well as the
~~  {{{../documentation/component-lifecycle.html} Component Lifecycle}} documentation.
  ...
  discussed in the {{{/guides/developer-guide/building-components/component-testing.html} Component Testing}} section of the developer guide.
  ...
  {{{http://continuum.apache.org/} Apache Continuum}}, a Plexus application. By replacing some components with
...
What are Components?
  ...
  Other projects have also offered what a component may be:
    ...
    * {{{http://picocontainer.codehaus.org/Inversion+of+Control} PicoContainer}}
